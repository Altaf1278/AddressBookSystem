...
public class AddressBookMain {
	...
	public static void main(String[] args) throws IOException {
		...
		// csv file to read
		String csvFile = "C:\\Users\\altaf\\eclipse-workspace\\AdvanceAddressBook\\Addbook.csv";
		addressBook.read(csvFile);

		// csv file to write
		String csvFileToWrite = "C:\\Users\\altaf\\eclipse-workspace\\AdvanceAddressBook\\Addbook.csv";
		...
		String[][] dataToWrite = {
				...
				{ "Aman", "Sayyed", "Pimpri", "Pune", "Maharashtra", "450662", "8520396310",
						"Rajusmith@example.com" } };
